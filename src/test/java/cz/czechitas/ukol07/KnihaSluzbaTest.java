...
class KnihaSluzbaTest {
    ...
    void testVratiSeznamOdZadanehoAutora() {
        ...
        List<Kniha> knihyOdAutora = knihaSluzba.vratiSeznamOdZadanehoAutora("Božena Němcová");

        assertEquals(4, knihyOdAutora.size(), "Mělo by být vráceno 4 knihy od autora B. Němcové");
    }
    ...
    public void testKnihyOdNeexistujicihoAutora() {
        ...
        List<Kniha> knihyOdAutora = knihaSluzba.vratiSeznamOdZadanehoAutora("Neexistující Autor");
    ...
    void testVratiSeznamVZadanemRoce() {
        ...
        List<Kniha> knihyVRoce = knihaSluzba.vratiSeznamVZadanemRoce(1856);
    ...
    public void testKnihyVRoceKdyzZadnyRokNenajde() {
        ...
        List<Kniha> knihyVRoce = knihaSluzba.vratiSeznamVZadanemRoce(2025);
